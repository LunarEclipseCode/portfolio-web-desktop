...
const SaveIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg" aria-labelledby="saveIconTitle" stroke="currentColor" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" fill="none" color="currentColor">
    {" "}
...
const ToolItem = ({ onClick, imgSrc, altText, toolName, description }) => (
  ...
  >
    <div className="h-24 w-24">
      <img src={imgSrc} alt={altText} className="object-cover h-full w-full filter invert contrast-200 brightness-200" />
    </div>
...
export class DevToys extends Component {
  constructor() {
    ...
    this.state = {
      ...
      // Password Generator
      uppercase: false,
      passwordLength: 12, // Password Generator state
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (prevState.selectedTool !== this.state.selectedTool && this.scrollableRef.current) {
  ...
  renderJsonToYamlConverter = () => {
    ...
    return (
      <main className="overflow-y-auto p-4 md:p-6 lg:p-8 xl:p-10 h-full">
        <CustomScrollbar />
        <section className="flex flex-col gap-6 h-full">
          <h1 className="text-3xl text-white font-semibold">JSON to YAML Converter</h1>
          <section className="flex flex-col lg:flex-row gap-4 h-full">
            <div className="flex-1 flex flex-col h-full">
              ...
              <textarea
                className="flex-1 h-full border-2 rounded-lg border-gray-600 bg-gray-800 px-4 py-2 text-white outline-none placeholder-gray-500 hover:bg-gray-700 focus:border-blue-400 focus:bg-gray-700 font-mono custom-scrollbar"
    ...
    return (
      <main className="overflow-y-auto p-4 md:p-6 lg:p-8 xl:p-10 h-full">
        <section className="flex flex-col gap-6">
          <h1 className="text-3xl text-white font-semibold">Number Base Converter</h1>
          <section className="flex flex-col gap-4">
            <ul className="flex flex-col gap-4">
              <li>
                <div className="flex h-14 items-center gap-6 rounded-lg border bg-gray-700 px-4">
                  ...
                  <div className="flex flex-1 justify-end">
                    <div className="flex flex-row-reverse items-center">
                      ...
                      <label className="leading-none cursor-pointer pr-3 text-white">On</label>
                    </div>
                  </div>
                </div>
              </li>
      ...
      <section className="flex flex-col gap-2">
        <div className="flex justify-between">
          ...
          <div className="flex">
            ...
            <button className="text-gray-400 hover:text-white transition-colors p-2" onClick={() => this.pasteFromClipboard(onChange)}>
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-clipboard">
                <path d="M16 4h-2a2 2 0 0 0-4 0H8a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2z"></path>
                <rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect>
              </svg>
        ...
        <section className="flex flex-col gap-6">
          ...
          <section className="flex flex-col gap-4">
            <div className="flex justify-between">
              ...
              {/* <div className="flex">
                <button className="text-gray-400 hover:text-white transition-colors mr-2" onClick={() => this.pasteFromClipboard(this.handleHashInputChange)}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-clipboard">
                    <path d="M16 4h-2a2 2 0 0 0-4 0H8a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2z"></path>
                    <rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect>
                  </svg>
        ...
        <section className="flex flex-col gap-0">
          ...
          <section className="flex flex-col gap-4">
            <ul className="flex flex-col gap-4">
              ...
              <li>
                <div className="flex items-center gap-6 rounded-lg bg-gray-800 px-4 h-14">
          ...
          <section className="flex flex-col gap-4">
            <div className="relative h-64 border-2 rounded-lg border-gray-600 bg-gray-800 px-4 py-2 text-white overflow-auto custom-scrollbar">
    ...
    return (
      <main className="overflow-y-auto p-4 md:p-6 lg:p-8 xl:p-10 h-full">
        ...
        <section className="flex flex-col gap-6">
          ...
          <section className="flex flex-col gap-4">
            <div className="relative h-72 border-2 rounded-lg border-gray-600 bg-gray-800 px-4 py-2 text-white overflow-auto custom-scrollbar">
  ...
  renderCodeFormatter = () => {
    ...
    return (
      <main className="overflow-y-auto p-4 md:p-6 lg:p-8 xl:p-10 h-full">
        <CustomScrollbar />
        <section className="flex flex-col gap-6 h-full">
          <h1 className="text-3xl text-white font-semibold">Code Formatter</h1>
          <section className="flex flex-col gap-4">
            <ul className="flex flex-col gap-4">
              <li>
                <div className="flex h-14 items-center gap-6 rounded-lg bg-gray-700 px-4">
                  <label className="text-white">Select Language:</label>
                  <select value={selectedLanguage} onChange={this.handleLanguageChange} className="bg-gray-600 text-white rounded-md p-2 pl-3">
      ...
      <main className="overflow-y-auto p-4 md:p-6 lg:p-8 xl:p-10 h-full">
        ...
        <section className="flex flex-col gap-6 h-full">
          ...
          <section className="flex flex-col gap-4">
            <ul className="flex flex-col gap-4">
              <li>
                <div className="flex h-16 items-center gap-6 rounded-lg border bg-gray-700 px-4">
                  <span className="text-white">Mode</span>
                  <div className="flex flex-1 justify-end">
                    <div className="flex flex-row-reverse items-center">
                      <button
            ...
            <div className="flex-1 flex flex-col h-full">
              ...
              {qrMode === "encode" ? (
                qrOutput ? (
                  ...
                  <div className="flex-1 h-full border-2 rounded-lg border-gray-600 bg-gray-800 px-4 py-2 text-white outline-none placeholder-gray-500 hover:bg-gray-700 focus:border-blue-400 focus:bg-gray-700 font-mono custom-scrollbar"></div>
                )
              ) : (
                <div
                  className={`flex-1 h-full border-2 rounded-lg px-4 py-2 text-white outline-none placeholder-gray-500 hover:bg-gray-700 focus:border-blue-400 focus:bg-gray-700 font-mono custom-scrollbar ${
  ...
  handleBaseSelection = (e) => {
    this.setState({ selectedBase: e.target.value, baseInput: "", baseOutput: "", baseError: null }, () => {
      this.processBaseConversion(this.state.baseInput, this.state.isEncoding);
    });
  };
  ...
  renderColorConverter = () => {
    const { colorInput, rgb, hsl, cmyk, pantone, tailwind, cssFilter, error } = this.state;
      ...
      <main className="overflow-y-auto p-4 md:p-6 lg:p-8 xl:p-10 h-full">
        <section className="flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <input type="color" onChange={this.handleColorPickerChange} value={colorInput} className="w-8 h-9 border-none bg-transparent cursor-pointer" />
          </div>
          <div className="w-full h-32 rounded-lg shadow-lg" style={{ backgroundColor: error ? "white" : colorInput }}></div>
          ...
          <section className="mt-4">{this.renderColorSection("CSS Filter", cssFilter, () => {}, true)}</section>
        </section>
      </main>
    );
  };
              ...
              <li>
                <div className="flex flex-col gap-4">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-4 justify-end">
                    <label htmlFor="password" className="text-white sm:mb-0 mb-2">
                      Password:
                    </label>
          ...
          <section className="flex flex-col lg:flex-row gap-4 h-full">
            ...
            <div className="flex-1 flex flex-col h-full">
              ...
              <textarea
                ...
                } bg-gray-800 px-4 py-2 text-white outline-none placeholder-gray-500 hover:bg-gray-700 focus:border-blue-400 focus:bg-gray-700 font-mono custom-scrollbar`}
  ...
  renderHomeScreen = () => {
    return (
      <div className="p-4 grid gap-3 xl:gap-4 grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 mt-4">
        <ToolItem onClick={() => this.handleCardClick("jsonToYaml")} class="fill-white" imgSrc="./images/devtoys/JsonYaml.svg" altText="Json to Yaml Icon" toolName="Json <> Yaml Converter" description="Convert Json data to Yaml and vice versa" />
        <ToolItem onClick={() => this.handleCardClick("baseConverter")} imgSrc="./images/devtoys/hash2.svg" altText="Number Base Converter Icon" toolName="Number Base Converter" description="Convert numbers from one base to another" />
        <ToolItem onClick={() => this.handleCardClick("hashGenerator")} imgSrc="./images/devtoys/fingerprint.svg" altText="Hash Generator Icon" toolName="Hash Generator" description="Calculate hash from text input" />
        <ToolItem onClick={() => this.handleCardClick("passwordGenerator")} imgSrc="./images/devtoys/key2.svg" altText="Password Generator Icon" toolName="Password Generator" description="Generate random passwords" />
        <ToolItem onClick={() => this.handleCardClick("loremipsumGenerator")} imgSrc="./images/devtoys/text.svg" altText="Password Generator Icon" toolName="Lorem Ipsum Generator" description="Generate placeholder text" />
        <ToolItem onClick={() => this.handleCardClick("codeFormatter")} imgSrc="./images/devtoys/code.svg" altText="Password Generator Icon" toolName="Code Formatter" description="Make your code prettier" />
        <ToolItem onClick={() => this.handleCardClick("morseEncoderDecoder")} imgSrc="./images/devtoys/wave.svg" altText="Morse Encoder/Decoder Icon" toolName="Morse Code Encoder/Decoder" description="Encode or decode Morse Code" />
        <ToolItem onClick={() => this.handleCardClick("qrCodeEncoderDecoder")} imgSrc="./images/devtoys/qr_code.svg" altText="QR Code Encoder/Decoder Icon" toolName="QR Code Encoder/Decoder" description="Encode or decode QR Code" />
        <ToolItem onClick={() => this.handleCardClick("baseEncoderDecoder")} imgSrc="./images/devtoys/encode.svg" altText="Base64 Encoder/Decoder Icon" toolName="Base Encoder/Decoder" description="Encode or decode text using various base encodings" />
        <ToolItem onClick={() => this.handleCardClick("colorConverter")} imgSrc="./images/devtoys/color.svg" altText="Color Converter Icon" toolName="Color Converter" description="Convert between different color conventions" />
        <ToolItem onClick={() => this.handleCardClick("aesEncrypterDecrypter")} imgSrc="./images/devtoys/lock.svg" altText="AES256 Encrypter Decrypter Icon" toolName="AES256 Encrypter/Decrypter" description="Encrypt or decrypt your text using AES256-GCM" />
        <style jsx>{`
          .icon-white img {
  ...
  render() {
    return (
      <div className="w-full h-full flex flex-col bg-gray-900 text-white select-none overflow-y-auto custom-appscrollbar" ref={this.scrollableRef}>
        {this.state.showTopBar && (
          <div className="flex items-center justify-between w-full bg-gray-800 bg-opacity-60 text-sm p-2">
            <button onClick={this.handleBackToHome} className="p-2 rounded hover:bg-gray-700">
              <img src="./images/devtoys/home.svg" alt="Home" width="20" height="20" />
            </button>
            <div className="flex">
              <button onClick={() => this.handleCardClick("baseConverter")} className="p-2 rounded hover:bg-gray-700">
                <img src="./images/devtoys/hash.svg" alt="Hash" width="20" height="20" />
              </button>
              <button onClick={() => this.handleCardClick("jsonToYaml")} className="p-2 rounded hover:bg-gray-700">
                <img src="./images/devtoys/converter.svg" alt="Convert" width="20" height="20" />
              </button>
              <button onClick={() => this.handleCardClick("hashGenerator")} className="p-2 rounded hover:bg-gray-700">
                <img src="./images/devtoys/hash.svg" alt="Lock" width="20" height="20" />
              </button>
            </div>
          </div>
        )}
        <div className="flex-grow flex flex-col p-4">{this.state.selectedTool ? this.renderToolContent() : this.renderHomeScreen()}</div>
        <style jsx>{`
