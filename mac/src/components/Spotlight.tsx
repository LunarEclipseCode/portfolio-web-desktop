            ...
            <div className="flex-1 vstack">
              ...
              <div className="flex-1 hstack text-xs">
                ...
                <div className="flex-1 pl-2 text-c-black">
                  ...
                  <div>{curDetails.size}</div>
                  <div>{format(new Date(curDetails.created), "MM/dd/yyyy")}</div>
                  <div>{format(new Date(curDetails.modified), "MM/dd/yyyy")}</div>
                </div>
              </div>
            </div>
          )}
